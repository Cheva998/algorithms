#http://www.codeskulptor.org/#user39_BDasGPXfl5_9.py

##### Un solo jugador contra la máquina
#http://www.codeskulptor.org/#user39_BDasGPXfl5_12.py

#### retorno a la mitad
#http://www.codeskulptor.org/#user39_BDasGPXfl5_14.py

#### predictivo
#http://www.codeskulptor.org/#user39_BDasGPXfl5_17.py
...
def spawn_ball(direction):
    ...
    ball_vel = [0, 0]
    if direction == "right":
        ball_vel[0] = 2 + random.random() * 1.5
    elif direction == "left":
        ball_vel[0] = -(2 + random.random() * 1.5)
    
    ball_vel[1] = -(2 + random.random() * 2)
